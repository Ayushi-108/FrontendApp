...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        btnViewSubmissions.Location = New Point(226, 136)
        btnViewSubmissions.Name = "btnViewSubmissions"
        btnViewSubmissions.Size = New Size(280, 38)
        ...
        ' btnCreateSubmission
        ' 
        btnCreateSubmission.BackColor = Color.LightYellow
        btnCreateSubmission.Location = New Point(226, 195)
        btnCreateSubmission.Name = "btnCreateSubmission"
        btnCreateSubmission.Size = New Size(280, 42)
